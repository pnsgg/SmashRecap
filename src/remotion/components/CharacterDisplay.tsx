...
interface CharacterDisplayProps {
  ...
  gradientColors?: [string, string]; // e.g. ['#414BC3', '#5075DA']
}
  ...
  return (
    <AbsoluteFill id="remotion-root">
      ...
      >
        <div
          style={{
            background: `linear-gradient(to bottom left, ${gradientColors[0]}, ${gradientColors[1]})`,
...
export const SubtitleText: React.FC<{ children: React.ReactNode; style?: React.CSSProperties }> = ({
  children,
  style
}) => {
...
export const SubtitleTextWhite: React.FC<{
